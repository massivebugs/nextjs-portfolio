...
import AppearingText from "@/components/atoms/AppearingText"
...
test("does not animate when restore is false", () => {
  render(
    <p>
      <AppearingText text="This is a test string!" initialPos="left" restore={false} />
    </p>
  )
...
test("renders an empty string at 0 duration", () => {
  ...
  render(
    <p>
      <AppearingText text="This is a test string!" initialPos="left" restore={true} />
    </p>
  )
