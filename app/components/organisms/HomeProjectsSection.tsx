...
const HomeProjectsSection = forwardRef(
    ...
    const projects: Project[] = [
        ...
        description: (
          <div>
            ...
            <ul className="list-disc pl-5 [&>li]:mb-1">
              ...
              <li>
                I implemented{" "}
                <span className="font-bold">Front-end web app</span> features
      ...
      },
      {
        ...
        description: (
          <div>
            ...
            <p className="mb-3">
              It's kind of difficult to explain what it is, so here is a video
              of what the app is like:
            </p>
            <ul className="list-disc pl-5 [&>li]:mb-1">
              <li>
                I was incharge of
              ...
              <li>
                ...
                <span className="font-bold">Back-end and Front-end</span> and
                set up most of the{" "}
      ...
      },
      {
        ...
        description: (
          <div>
            <p>
              I wanted to make a portfolio which would really embody who I am,
              and what I can do.
            </p>
